...
public:
	...
	FOnPlayerStateChengedSignature SpellPointsChanged;
	...
	UFUNCTION(BlueprintCallable)
	void SpellRowsGlobePressed(const FGameplayTag& SlotTag, const FGameplayTag& AbilityType);
...
private:
	...
	FSelectedAbility SelectedAbility = {
		FAuraGameplayTags::Get().AbilitiesNone, FAuraGameplayTags::Get().AbilitiesStatusLocked
	};
